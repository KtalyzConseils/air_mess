...
const PROFILE_COPY = {
  fr: {
    ...
    visibleDrivers: "Le badge sera ajoute apres verification par l'equipe AirMess.",
    trustBadge: 'Badge de confiance',
    trustBadgeReady: 'Votre profil est pret pour la verification AirMess.',
    trustBadgePending: "Votre profil est complet. L'equipe AirMess peut maintenant le verifier.",
    ...
    becomeDriverTitle: 'Devenir livreur AirMess',
    becomeDriverSubtitle: "Candidature, validation, puis application livreur.",
    becomeDriverBody: "L'inscription livreur se fait sur le formulaire web AirMess. Notre equipe verifie ensuite les documents sous 24-48h.",
    becomeDriverStepApply: 'Remplis le formulaire de candidature',
    becomeDriverStepValidate: "Attends la validation de l'equipe AirMess",
  ...
  en: {
    ...
    visibleDrivers: 'The badge will be added after verification by the AirMess team.',
    trustBadge: 'Trust badge',
    trustBadgeReady: 'Your profile is ready for AirMess verification.',
    trustBadgePending: 'Your profile is complete. The AirMess team can now verify it.',
    ...
    becomeDriverTitle: 'Become an AirMess driver',
    becomeDriverSubtitle: 'Application, approval, then courier app.',
    becomeDriverBody: 'Driver registration is handled on the AirMess web form. Our team then verifies your documents within 24-48h.',
    becomeDriverStepApply: 'Fill in the driver application form',
    becomeDriverStepValidate: 'Wait for AirMess approval',
