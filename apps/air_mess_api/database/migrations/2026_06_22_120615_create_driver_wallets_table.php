...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // SQLite (utilisé en tests) ne supporte pas ALTER TABLE ADD CONSTRAINT.
        ...
        // (NOW() n'existe pas en SQLite → skip en tests : les factories fournissent
        //  les wallets à la demande, pas besoin de backfill.)
        if (DB::getDriverName() === 'pgsql') {
            DB::statement(<<<'SQL'
