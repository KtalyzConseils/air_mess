...
class CheckExpoPushReceipts implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        foreach ($receipts as $receiptId => $receipt) {
            if (($receipt['status'] ?? null) !== 'error') continue;
        ...
        // Expo peut ne pas avoir produit tous les receipts lors du premier contrôle.
        // On garde uniquement ceux encore absents et on réessaie quelques minutes plus tard.
